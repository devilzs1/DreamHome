    ...
    <section>
      <div className="container mx-auto min-h-[800px] mb-14">
        ...
        <div className="flex flex-col items-start gap-8 lg:flex-row">
          ...
          <div
            className={`flex-1 w-full mb-8 border border-gray-300 rounded-lg px-6 py-8 ${
              isDarkMode
                ? "bg-white-800 text-black-700"
          ...
          >
            ...
            <form className="flex flex-col gap-y-4">
              ...
              <textarea
                ...
                placeholder="Message*"
                defaultValue="Hello, I am looking for Apartments"
              />
              <button className="border bg-green-600 text-white hover:bg-green-700 rounded p-4 text-sm w-full transition ">
                Send message
              </button>
